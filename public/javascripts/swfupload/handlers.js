...
function uploadStart(file) {
	document.getElementById("myseccess").style.display = "block";
	try {
...
function uploadSuccess(file, serverData) {
	...
	try {
		if(isSuccess){
			...
			var bar = document.getElementById(file.id+"_bar");
			bar.parentNode.innerHTML="上传成功！匹配成功！";
			var delObject = document.getElementById(file.id+"_del");
			delObject.parentNode.innerHTML="&nbsp;";
			...
			tr.style.color="red";
			var bar = document.getElementById(file.id+"_bar");
			bar.parentNode.innerHTML=""+serverData;
			var delObject = document.getElementById(file.id+"_del");
			delObject.parentNode.innerHTML="&nbsp;";
		}
		document.getElementById("myseccess").style.display = "none";
	} catch (ex) {
		this.debug(ex);
	}
	/*
