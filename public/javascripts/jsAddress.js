...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea, defaultLength)
{
	...
	{
		if (!cmbArea) return;
		cmbArea.options.length = defaultLength;
	...
	{
		cmbCity.options.length = defaultLength;
...
{name:'台湾', cityList:[{name:'台湾', areaList:["台北","高雄","台中","花莲","基隆","嘉义","金门","连江","苗栗","南投","澎湖","屏东","台东","台南","桃园","新竹","宜兰","云林","彰化"]}
]},
{name:'香港', cityList:[{name:'香港', areaList:["中西区","东区","九龙城区","观塘区","南区","深水埗区","湾仔区","黄大仙区","油尖旺区","离岛区","葵青区","北区","西贡区","沙田区","屯门区","大埔区","荃湾区","元朗区"]}
]},
{name:'澳门', cityList:[{name:'澳门', areaList:["花地玛堂区","花王堂区","望德堂区","风顺堂区","大堂区"]}
]}
];